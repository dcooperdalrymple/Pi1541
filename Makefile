OBJS	= armc-start.o armc-cstartup.o armc-cstubs.o armc-cppstubs.o \
	exception.o main.o rpi-aux.o rpi-i2c.o rpi-spi.o rpi-mailbox-interface.o rpi-mailbox.o \
	...
	gcr.o prot.o lz.o emmc.o diskio.o options.o Screen.o ili9340.o ScreenTFT.o SSD1306.o ScreenLCD.o \
